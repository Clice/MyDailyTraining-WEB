...
$alterarDadosInstrutor = "UPDATE usuarios SET emailUsuario = ?, senhaUsuario = ?, enderecoUsuario = ?, telefoneUsuario = ?, cidadeUsuario = ?, cepUsuario = ?, bairroUsuario = ?, estadoUsuario = ? WHERE idUsuario = ? AND tipoConta = 4";
