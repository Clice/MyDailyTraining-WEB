                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div style="float: right;" class="form-actions">
                                                <button type="submit" class="btn btn-success" onclick="verificarQtdAlunos();">
...
<script type="text/javascript">
    function verificarQtdAlunos() {
        var idAcademia = $('#idAcademia').val();
        var dados = "idAcademia=" + idAcademia;
        $.ajax({
            url: "<?php echo base_url('AcademiaController/cVerificarQtdAlunos') ?>",
            type: "POST",
            data: dados,
            dataType: "JSON",
