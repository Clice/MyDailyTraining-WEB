                                                        ...
                                                        <?php for ($i = 0; $i < count($diasTreinoAluno); $i++) { ?>
                                                            <?php if (strstr($diasTreinoAluno[$i], "Domingo")) { ?>
                                                                ...
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="domingo" <?php if ($treino[0]->domingo == true) echo "checked"; ?>
                                                            ...
                                                            <?php if (strstr($diasTreinoAluno[$i], "Segunda")) { ?>
                                                                <!-- SEGUNDA -->
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="segunda"  <?php if ($treino[0]->segunda == true) echo "checked"; ?>
                                                            ...
                                                            <?php if (strstr($diasTreinoAluno[$i], "Terça")) { ?>
                                                                <!-- TERÇA -->
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="terca"  <?php if ($treino[0]->terca == true) echo "checked"; ?>
                                                            ...
                                                            <?php if (strstr($diasTreinoAluno[$i], "Quarta")) { ?>
                                                                <!-- QUARTA -->
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="quarta"  <?php if ($treino[0]->quarta == true) echo "checked"; ?>
                                                            ...
                                                            <?php if (strstr($diasTreinoAluno[$i], "Quinta")) { ?>
                                                                <!-- QUINTA -->
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="quinta"  <?php if ($treino[0]->quinta == true) echo "checked"; ?>
                                                            ...
                                                            <?php if (strstr($diasTreinoAluno[$i], "Sexta")) { ?>
                                                                <!-- SEXTA -->
                                                                <label class="display-inline-block custom-control custom-checkbox" style="margin-right: 70px;">
                                                                    <input type="checkbox" name="diasTreinoAluno[]" id="sexta"  <?php if ($treino[0]->sexta == true) echo "checked"; ?>
