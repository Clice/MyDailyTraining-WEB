                                        ...
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nomeUsuario" class="form-control" 
                                                               placeholder="Digite o nome do funcionario" name="nomeUsuario" value="<?php if ($idUsuario != "novo") echo $nomeUsuario; ?>" minlength="5">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>CEP:*</label>
                                                        <input type="text" id="cepUsuario" class="form-control" maxlength="9" placeholder="Digite o CEP" name="cepUsuario" value="<?php if ($idUsuario != "novo") echo $cepUsuario; ?>" data-mask="00000-000">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
