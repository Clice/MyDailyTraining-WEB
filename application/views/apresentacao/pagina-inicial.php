<html lang="portuguese-brasilian">
    <head>
        ...
        <!-- CSS -->
        <link href="<?php echo base_url('assets/css/apresentacao/bootstrap.css'); ?>" rel="stylesheet">      
        ...
        <link href="<?php echo base_url('assets/css/apresentacao/freelancer.css'); ?>" rel="stylesheet">
    ...
    <body id="body">
            ...
            <div class="row h-100">
                ...
                <div class="col-lg-6 my-auto"> 
                    <div class="header-content mx-auto">
                        <br>
                        <h4 style="text-align: justify; margin-left: 9%;" class="text-secondary mb-10">O MyDailyTraining busca inovar na 
                        ...
                        <br>
                        <a style="float: right;" href="<?php echo base_url('login'); ?>" 
                           class="btn btn-primary btn-xl btn-right">Acesse a plataforma</a>
                    </div>
                </div>
            </div>
        </header>
        ...
        <!-- Footer -->
        <footer class="footer text-center text-secondary bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 mb-5 mb-lg-0" style="margin-left: 33%;">
                        ...
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item">
                                <a class="btn btn-outline-dark btn-social text-center text-secondary rounded-circle" href="#">
        ...
        <!-- SCRIPTS -->        
        <script src="<?php echo base_url('assets/js/apresentacao/jquery.js'); ?>"></script>         
        <script src="<?php echo base_url('assets/js/apresentacao/jquery.easing.js'); ?>"></script>   
        <script src="<?php echo base_url('assets/js/apresentacao/freelancer.js'); ?>"></script>
