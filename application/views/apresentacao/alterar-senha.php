    ...
    <body style="background-color: #209AED;" data-open="click" data-menu="vertical-menu" data-col="1-column" class="vertical-layout vertical-menu 1-column blank-page blank-page">
                    ...
                    <section class="flexbox-container">
                        <div style="box-shadow: 10px 10px 10px rgba(0,0,0,0.5); border-radius: 10px;" class="col-md-4 offset-md-4 col-xs-10 offset-xs-1 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                ...
                                <input type="hidden" name="cpfUsuario" id="cpfUsuario" value="<?php echo $cpfUsuario; ?>">
                                ...
                                <div class="card-header no-border">
                                    ...
                                    <h4 class="card-subtitle text-xs-center pt-2"><span>Alterar a senha</span></h4>
                                </div>
                                <!-- CORPO DO LOGIN -->           
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <form class="form" id="formAlterarSenha" name="formAlterarSenha">
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-12" >
                                        ...
                                        <div class="offset-md-3 col-md-5">
                                            <button style="margin-left: 15px;" type="submit" class="btn btn-blue btn-lg btn-block" onclick="recuperarSenha();"><i class="icon-save"></i> Alterar</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            function recuperarSenha() {
                var url = "<?php echo base_url('sistema/LoginController/cProcurarCPF') ?>";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.success) {
                            window.location.href = "<?php echo base_url('alterar-senha'); ?>";
                        } else {
