<html lang="en">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1">
                            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contatos">Contatos</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <header class="masthead bg-white text-secondary text-center">
            <div class="container">
                <img class="img-fluid mb-5 d-block mx-auto" src="<?php echo base_url('assets/imagens/Icon.png'); ?>" alt="" style="height: 45%;">
                <h1 class="mb-0">MyDailyTraining</h1>
                <hr class="star-dark">
                <h2 class="font-weight-light mb-0">Sistema de Gerencimento de Academias e Acompanhamento de Alunos</h2>
            </div>
        </header>
        ...
        <header class="masthead bg-white text-secondary text-center">
            <div class="container">
                <img class="img-fluid mb-5 d-block mx-auto" src="<?php echo base_url('assets/imagens/Icon.png'); ?>" style="height: 45%;" alt="" >
                <h1 class="mb-0">MyDailyTraining</h1>
                <hr class="star-dark">
                <h2 class="mb-0">Sistema de Gerencimento de Academias e Acompanhamento de Alunos</h2>
            </div>
        </header>

        <!-- About Section -->
        <section class="bg-white text-white mb-0" id="equaltech">
            <div class="container">
        ...
        <!-- About Section -->
        <section class="bg-white text-white mb-0" id="contatos">
            <div class="container">
                <h2 class="text-center text-uppercase text-white">About</h2>
                <hr class="star-light mb-5">
                <div class="row">
