                    ...
                    <section class="flexbox-container">
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1">
                            <div class="card-header bg-transparent no-border pb-0">
                                ...
                                <h3 class="text-uppercase text-xs-center">Página Não Encontrada e/ou Acesso Proibido.</h3>
                            </div>
                            <div class="card-body collapse in">
                                <div class="row py-2">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <a href="https://www.mydailytraining.com.br" class="btn btn-primary btn-block font-small-3"><i class="icon-home4"></i> Voltar a Página Inicial</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer bg-transparent pb-0">
                                <div class="row">
                                    ...
                                    <div class="text-xs-center">
                                        <a href="https://www.facebook.com/mydailytraining" class="btn btn-social-icon mr-1 mb-1 btn-outline-facebook"><span class="icon-facebook3"></span></a>
