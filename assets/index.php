<html lang="pt-br" data-textdirection="ltr" class="loading">    
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="./fonts/fonts/icomoon.css">
                            ...
                            <div class="card-body collapse in">
                                <div class="row py-2">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <a href="" class="btn btn-primary btn-block font-small-3"><i class="icon-home4"></i> Voltar a Página Inicial</a>
                                    </div>
                                </div>
                            </div>
